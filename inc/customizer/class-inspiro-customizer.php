				...
				new Inspiro_Customize_Section_Pro(
					...
					array(
						'title'       => esc_html__( 'Upgrade to Inspiro Premium', 'inspiro' ),
						 'description' => esc_html__( 'Unlock premium features: 50+ Elementor and Gutenberg Demos, 7 Style Kits, Header Builder, Video Backgrounds, Portfolio Integration, Premium Support and much more!', 'inspiro' ),
