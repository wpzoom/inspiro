                            ...
                            <div class="wpz-grid-wrap">
                                ...
                                <div class="section quick-action-section">
                                    <div class="section-content">
                                        ...
                                        <?php esc_html_e( 'If you have purchased the Premium version of the theme, please download it as a ZIP file from the Members Area and upload it in the form on the left.', 'inspiro' ); ?>
                                    </div>
                                </div>
                            </div>
