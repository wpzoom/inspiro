<?php
/**
 * Title: Section with text and numbers
 * Slug: inspiro/section-with-text-and-numbers
 * Description: 
 * Categories: featured, inspiro
 * Keywords: 
 * Viewport Width: 1280
 * Block Types: 
 * Post Types: 
...
?>
<!-- wp:group {"align":"full","backgroundColor":"primary","layout":{"type":"constrained","wideSize":"","contentSize":""}} -->
<div class="wp-block-group alignfull has-primary-background-color has-background"><!-- wp:columns -->
...
<div class="wp-block-column" style="padding-left:0;flex-basis:20%"></div>
<!-- /wp:column -->
...
<p class="has-lightgrey-color has-text-color">the year that Inspiro Co. was established</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"lightgrey"} -->
<p class="has-lightgrey-color has-text-color">people work at Inspiro Co.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"lightgrey"} -->
<p class="has-lightgrey-color has-text-color">living alumni, as of May 2022</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
...
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"lightgrey"} -->
<p class="has-lightgrey-color has-text-color">Nobel laureats</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
