<?php
/**
 * Title: Social Footer CTA
 * Slug: inspiro/social-footer-cta
 * Description: 
 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"40px","bottom":"40px"},"margin":{"top":"0px"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"header-footer","textColor":"white","className":"is-style-default","layout":{"inherit":true,"type":"constrained"},"fontSize":"small"} -->
...
<div class="wp-block-outermost-icon-block items-justified-right"><div class="icon-container" style="width:22px"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="https://www.w3.org/2000/svg"><path d="M20.1905 6.47619L3.28571 23.4286C2.90476 23.8095 2.45206 24 1.92762 24C1.40444 24 0.95238 23.8095 0.571428 23.4286C0.190476 23.0476 0 22.5949 0 22.0705C0 21.5473 0.190476 21.0952 0.571428 20.7143L17.5238 3.80952H3.04762C2.50794 3.80952 2.05524 3.6273 1.68952 3.26286C1.32508 2.89714 1.14286 2.44444 1.14286 1.90476C1.14286 1.36508 1.32508 0.912381 1.68952 0.546667C2.05524 0.182223 2.50794 0 3.04762 0H22.0952C22.6349 0 23.087 0.182223 23.4514 0.546667C23.8171 0.912381 24 1.36508 24 1.90476V20.9524C24 21.4921 23.8171 21.9441 23.4514 22.3086C23.087 22.6743 22.6349 22.8571 22.0952 22.8571C21.5556 22.8571 21.1035 22.6743 20.739 22.3086C20.3733 21.9441 20.1905 21.4921 20.1905 20.9524V6.47619Z" fill="#EDEDED"></path></svg></div></div>
<!-- /wp:outermost/icon-block --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"42px"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42px"><!-- wp:outermost/icon-block {"iconName":"","width":36} -->
<div class="wp-block-outermost-icon-block"><div class="icon-container" style="width:36px"><svg width="44" height="50" viewBox="0 0 44 50" fill="none" xmlns="https://www.w3.org/2000/svg"><path d="M38.6364 40.9091H13.6364C12.3864 40.9091 11.3167 40.4644 10.4273 39.575C9.53636 38.6841 9.09091 37.6136 9.09091 36.3636V4.54545C9.09091 3.29545 9.53636 2.225 10.4273 1.33409C11.3167 0.444697 12.3864 0 13.6364 0H27.6705C28.2765 0 28.8545 0.113636 29.4045 0.340909C29.953 0.568182 30.4356 0.890152 30.8523 1.30682L41.875 12.3295C42.2917 12.7462 42.6136 13.2288 42.8409 13.7773C43.0682 14.3273 43.1818 14.9053 43.1818 15.5114V36.3636C43.1818 37.6136 42.7371 38.6841 41.8477 39.575C40.9568 40.4644 39.8864 40.9091 38.6364 40.9091ZM27.2727 4.54545H13.6364V36.3636H38.6364V15.9091H29.5455C28.9015 15.9091 28.3621 15.6917 27.9273 15.2568C27.4909 14.8205 27.2727 14.2803 27.2727 13.6364V4.54545ZM4.54545 50C3.29545 50 2.22576 49.5553 1.33636 48.6659C0.445455 47.775 0 46.7045 0 45.4545V15.9091C0 15.2652 0.218182 14.725 0.654546 14.2886C1.08939 13.8538 1.62879 13.6364 2.27273 13.6364C2.91667 13.6364 3.45682 13.8538 3.89318 14.2886C4.32803 14.725 4.54545 15.2652 4.54545 15.9091V45.4545H27.2727C27.9167 45.4545 28.4568 45.6727 28.8932 46.1091C29.328 46.5439 29.5455 47.0833 29.5455 47.7273C29.5455 48.3712 29.328 48.9106 28.8932 49.3455C28.4568 49.7818 27.9167 50 27.2727 50H4.54545ZM13.6364 4.54545V15.9091V4.54545V36.3636V4.54545Z" fill="var(--wp--preset--color--secondary)"></path></svg></div></div>
<!-- /wp:outermost/icon-block --></div>
<!-- /wp:column -->
...
<div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"42px"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42px"><!-- wp:outermost/icon-block {"iconName":"","width":36} -->
<div class="wp-block-outermost-icon-block"><div class="icon-container" style="width:36px"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="https://www.w3.org/2000/svg"><path d="M18.3203 0C15.5599 0 13.3268 2.23958 13.3268 5C13.3268 6.32161 13.8542 7.59766 14.7852 8.53516C15.7227 9.47266 16.9922 10 18.3203 10H23.3138V5C23.3138 2.24609 21.0807 0.00651042 18.3203 0ZM18.3203 13.3333H4.99349C2.23307 13.3333 0 15.5729 0 18.3333C0 21.0938 2.23958 23.3333 4.99349 23.3333H18.3138C21.0742 23.3333 23.3073 21.0938 23.3073 18.3333C23.3138 15.5729 21.0742 13.3333 18.3203 13.3333ZM31.6406 23.3333C34.401 23.3333 36.6406 21.0938 36.6341 18.3333V5C36.6341 2.23958 34.401 0 31.6406 0C28.8802 0 26.6471 2.23958 26.6471 5V18.3333C26.6471 21.1003 28.8802 23.3333 31.6406 23.3333ZM49.9609 18.3333C49.9609 15.5729 47.7214 13.3333 44.9674 13.3333C42.2135 13.3333 39.974 15.5729 39.974 18.3333V23.3333H44.9674C47.7214 23.3333 49.9609 21.0938 49.9609 18.3333ZM44.9609 26.6667H31.6406C28.8802 26.6667 26.6471 28.9062 26.6471 31.6667C26.6471 32.9883 27.1745 34.2643 28.1055 35.2018C29.043 36.1393 30.3125 36.6667 31.6406 36.6667H44.9609C47.7214 36.6667 49.9544 34.4271 49.9544 31.6667C49.9609 28.9062 47.7214 26.6732 44.9609 26.6667ZM31.6406 40H26.6471V45C26.6471 47.7604 28.8867 50 31.6406 50C34.401 50 36.6406 47.7604 36.6341 45C36.6406 42.2396 34.401 40.0065 31.6406 40ZM18.3203 26.6667C15.5599 26.6667 13.3268 28.9062 13.3268 31.6667V45C13.3268 47.7604 15.5664 50 18.3203 50C21.0807 50 23.3203 47.7604 23.3138 45V31.6667C23.3138 30.3451 22.7865 29.069 21.8555 28.1315C20.918 27.194 19.6419 26.6667 18.3203 26.6667ZM0 31.6667C0 32.9883 0.527343 34.2643 1.45833 35.2018C2.39583 36.1393 3.66536 36.6667 4.99349 36.6667C7.75391 36.6667 9.99349 34.4271 9.98698 31.6667V26.6667H4.99349C2.23958 26.6667 0 28.9062 0 31.6667Z" fill="var(--wp--preset--color--secondary)"></path></svg></div></div>
<!-- /wp:outermost/icon-block --></div>
<!-- /wp:column -->
...
<div class="wp-block-columns"><!-- wp:column {"verticalAlignment":"center","width":"42px"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:42px"><!-- wp:social-links {"iconColor":"secondary","iconColorValue":"#0bb4aa","size":"has-large-icon-size","className":"is-style-logos-only","layout":{"type":"flex","justifyContent":"left"}} -->
<ul class="wp-block-social-links has-large-icon-size has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"#","service":"x"} /--></ul>
<!-- /wp:social-links --></div>
<!-- /wp:column -->
